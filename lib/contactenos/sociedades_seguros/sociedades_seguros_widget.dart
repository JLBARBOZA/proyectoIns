                ...
                child: StreamBuilder<List<SociedadesSegurosRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<SociedadesSegurosRecord>
                        listViewSociedadesSegurosRecordList = snapshot.data!;
                    return ListView.builder(
                      padding: EdgeInsets.zero,
                      primary: false,
                      shrinkWrap: true,
                      scrollDirection: Axis.vertical,
                      itemCount: listViewSociedadesSegurosRecordList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewSociedadesSegurosRecord =
                            listViewSociedadesSegurosRecordList[listViewIndex];
                        return Padding(
