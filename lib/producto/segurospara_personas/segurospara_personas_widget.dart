...
import 'segurospara_personas_model.dart';
export 'segurospara_personas_model.dart';

class SegurosparaPersonasWidget extends StatefulWidget {
  const SegurosparaPersonasWidget({Key? key}) : super(key: key);

  @override
  _SegurosparaPersonasWidgetState createState() =>
      _SegurosparaPersonasWidgetState();
}

class _SegurosparaPersonasWidgetState extends State<SegurosparaPersonasWidget> {
  late SegurosparaPersonasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SegurosparaPersonasModel());
  }
