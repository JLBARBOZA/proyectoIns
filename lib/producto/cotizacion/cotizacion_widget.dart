...
class _CotizacionWidgetState extends State<CotizacionWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CotizacionRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CotizacionRecord> cotizacionCotizacionRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final cotizacionCotizacionRecord =
            cotizacionCotizacionRecordList.isNotEmpty
                ? cotizacionCotizacionRecordList.first
                : null;
