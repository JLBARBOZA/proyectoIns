...
import 'bs_info_contra_model.dart';
export 'bs_info_contra_model.dart';

class BsInfoContraWidget extends StatefulWidget {
  const BsInfoContraWidget({Key? key}) : super(key: key);

  @override
  _BsInfoContraWidgetState createState() => _BsInfoContraWidgetState();
}

class _BsInfoContraWidgetState extends State<BsInfoContraWidget> {
  late BsInfoContraModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BsInfoContraModel());
  }
