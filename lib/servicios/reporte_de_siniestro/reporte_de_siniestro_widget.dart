                        ...
                        child: Align(
                          ...
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                10.0, 10.0, 10.0, 10.0),
                            child: Text(
                              'Si usted tuvo un accidente o cualquier situación amparada por los seguros del INS y necesita reportar un aviso de siniestro, sírvase completar este formulario digital. De esta forma, daremos inicio al proceso de trámite de su reclamo. Posteriormente se le estará contactando para dar continuidad al curso del mismo.',
                          ...
                          child: Padding(
                            ...
                            child: FlutterFlowDropDown<String>(
                              controller: _model.dropDownValueController2 ??=
                                ...
                                _model.dropDownValue2 ??= 'cedula fisica',
                              ),
                              options: ['cedula fisica'],
                              onChanged: (val) =>
