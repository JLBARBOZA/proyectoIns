...
import 'organigrama_model.dart';
export 'organigrama_model.dart';

class OrganigramaWidget extends StatefulWidget {
  const OrganigramaWidget({Key? key}) : super(key: key);

  @override
  _OrganigramaWidgetState createState() => _OrganigramaWidgetState();
}

class _OrganigramaWidgetState extends State<OrganigramaWidget> {
  late OrganigramaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrganigramaModel());
  }
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            context.pushNamed('descripcionPDF');
                                          },
                                          child: Text(
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          highlightColor: Colors.transparent,
                                          onTap: () async {
                                            context.pushNamed('organigramaPDF');
                                          },
                                          child: Text(
                                            'Organigrama Institucional\nMarzo 2023',
                                            style: FlutterFlowTheme.of(context)
