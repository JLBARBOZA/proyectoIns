...
import 'mision_vision_model.dart';
export 'mision_vision_model.dart';

class MisionVisionWidget extends StatefulWidget {
  const MisionVisionWidget({Key? key}) : super(key: key);

  @override
  _MisionVisionWidgetState createState() => _MisionVisionWidgetState();
}

class _MisionVisionWidgetState extends State<MisionVisionWidget> {
  late MisionVisionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MisionVisionModel());
  }
                          ...
                          Expanded(
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  20.0, 20.0, 20.0, 0.0),
                              child: Text(
                                'Misión, Visión, Valores, Propósito y Principios',
                                ...
                                child: RichText(
                                  text: TextSpan(
                                    children: [
                                      ...
                                      TextSpan(
                                        text:
                                            ' \nSomos INS, la empresa aseguradora que ofrece protección y prevención, con función social y generando valor sostenible.',
                                        style: TextStyle(
                                ...
                                child: RichText(
                                  text: TextSpan(
                                    children: [
                                      ...
                                      TextSpan(
                                        text:
                                            ' \nSer la mejor experiencia aseguradora.',
                                        style: TextStyle(
                                          color: FlutterFlowTheme.of(context)
                                              .primaryBtnText,
                                        ),
