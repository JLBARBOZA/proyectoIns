import '/components/bs_estadisticas_widget.dart';
import '/components/bs_gobierno_widget.dart';
import '/components/bs_info_red_widget.dart';
import '/components/bs_presupuesto_widget.dart';
import '/components/bs_reporte_widget.dart';
...
import 'gobierno_model.dart';
export 'gobierno_model.dart';

class GobiernoWidget extends StatefulWidget {
  const GobiernoWidget({Key? key}) : super(key: key);

  @override
  _GobiernoWidgetState createState() => _GobiernoWidgetState();
}

class _GobiernoWidgetState extends State<GobiernoWidget> {
  late GobiernoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GobiernoModel());
  }
                          ...
                          Expanded(
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  20.0, 20.0, 20.0, 20.0),
                              child: Text(
                                'Evalúa la publicación de conjuntos de datos pre-seleccionados en el sitio web de las instituciones públicas, de acuerdo con el cumplimiento del formato de datos abiertos, permitiendo su uso, reuso y libre distribución.',
