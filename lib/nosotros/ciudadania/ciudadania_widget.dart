...
import '/components/bs_invitaciones_widget.dart';
import '/components/bs_mecanismo_widget.dart';
import '/components/bs_solicitudes_widget.dart';
...
import 'ciudadania_model.dart';
export 'ciudadania_model.dart';

class CiudadaniaWidget extends StatefulWidget {
  const CiudadaniaWidget({Key? key}) : super(key: key);

  @override
  _CiudadaniaWidgetState createState() => _CiudadaniaWidgetState();
}

class _CiudadaniaWidgetState extends State<CiudadaniaWidget> {
  late CiudadaniaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CiudadaniaModel());
  }
