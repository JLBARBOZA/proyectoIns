...
import 'rendicion_cuentas_model.dart';
export 'rendicion_cuentas_model.dart';

class RendicionCuentasWidget extends StatefulWidget {
  const RendicionCuentasWidget({Key? key}) : super(key: key);

  @override
  _RendicionCuentasWidgetState createState() => _RendicionCuentasWidgetState();
}

class _RendicionCuentasWidgetState extends State<RendicionCuentasWidget> {
  late RendicionCuentasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RendicionCuentasModel());
  }
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            context
                                                .pushNamed('rendicion2022PDF');
                                          },
                                          child: Text(
                                            'Informe Anual de Rendicón de Cuentas 2022',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Readex Pro',
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            context
                                                .pushNamed('rendicion2021PDF');
                                          },
                                          child: Text(
                                            'Informe Anual de Rendicón de Cuentas 2021',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Readex Pro',
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            context
                                                .pushNamed('rendicion2020PDF');
                                          },
                                          child: Text(
                                            'Informe Anual de Rendicón de Cuentas 2020',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Readex Pro',
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          highlightColor: Colors.transparent,
                                          onTap: () async {
                                            context.pushNamed('informe2019PDF');
                                          },
                                          child: Text(
                                            'Informe Anual de Rendicón de Cuentas 2019',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Readex Pro',
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          highlightColor: Colors.transparent,
                                          onTap: () async {
                                            context.pushNamed('informe2018PDF');
                                          },
                                          child: Text(
                                            'Informe Anual de Rendicón de Cuentas 2018',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Readex Pro',
