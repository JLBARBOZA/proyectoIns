...
import 'informe_model.dart';
export 'informe_model.dart';

class InformeWidget extends StatefulWidget {
  const InformeWidget({Key? key}) : super(key: key);

  @override
  _InformeWidgetState createState() => _InformeWidgetState();
}

class _InformeWidgetState extends State<InformeWidget> {
  late InformeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InformeModel());
  }
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            context.pushNamed('informe2022PDF');
                                          },
                                          child: Text(
                                            'Informe Anual\nGobierno Corporativo 2022',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Readex Pro',
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          highlightColor: Colors.transparent,
                                          onTap: () async {
                                            context.pushNamed('informe2021PDF');
                                          },
                                          child: Text(
                                            'Informe Anual\nGobierno Corporativo 2021',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Readex Pro',
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          highlightColor: Colors.transparent,
                                          onTap: () async {
                                            context.pushNamed('informe2020PDF');
                                          },
                                          child: Text(
