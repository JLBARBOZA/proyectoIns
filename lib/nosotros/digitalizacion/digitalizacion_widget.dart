...
import 'digitalizacion_model.dart';
export 'digitalizacion_model.dart';

class DigitalizacionWidget extends StatefulWidget {
  const DigitalizacionWidget({Key? key}) : super(key: key);

  @override
  _DigitalizacionWidgetState createState() => _DigitalizacionWidgetState();
}

class _DigitalizacionWidgetState extends State<DigitalizacionWidget> {
  late DigitalizacionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DigitalizacionModel());
  }
                          ...
                          Expanded(
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  20.0, 20.0, 20.0, 20.0),
                              child: Text(
                                'El Programa de Proyectos Key consiste en la adquisición e implementación de diversas plataformas de gestión, con el fin de habilitar la tecnología necesaria para atender los objetivos relacionados con la transformación digital del Grupo INS.',
                          ...
                          child: Row(
                            ...
                            children: [
                              ClipRRect(
                                borderRadius: BorderRadius.circular(8.0),
                                child: Image.network(
                                  'https://www.grupoins.com/media/15600/key-salud-escritorio.jpg',
                                  width: 144.0,
                                  height: 116.0,
                                  fit: BoxFit.cover,
                                ),
                                ...
                                child: RichText(
                                  text: TextSpan(
                                    children: [
                                      ...
                                      TextSpan(
                                        text:
                                            ' \nAdquirir e implementar una solución tecnológica para automatizar y administrar todos los procesos de negocio relativos a la gestión médica y hospitalaria de la subsidiaria Red de Servicios de Salud S.A (empresa con una definición de atención de servicio auxiliar, respecto a la atención médica que se brinda a los asegurados del Instituto), previendo la integración con los sistemas del Grupo INS y otros que se requieran, con el fin de fortalecer el servicio que se brinda a los asegurados.',
                                        style: TextStyle(
                                          color: FlutterFlowTheme.of(context)
                                              .primaryBtnText,
                                        ),
                          ...
                          child: Row(
                            ...
                            children: [
                              ClipRRect(
                                borderRadius: BorderRadius.circular(8.0),
                                child: Image.network(
                                  'https://www.grupoins.com/media/15596/key-administrativo-escritorio.jpg',
                                  width: 144.0,
                                  height: 116.0,
                                  fit: BoxFit.cover,
                                ),
                              ...
                              Expanded(
                                child: RichText(
                                  text: TextSpan(
                                    children: [
                                      TextSpan(
                                        text: 'Proyecto KEY Administrativo',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Readex Pro',
                                      ...
                                      TextSpan(
                                        text:
                                            ' \nAdquirir e implementar la solución financiera y administrativa que cumpla con todos los requerimientos técnicos y funcionalidades requeridas. La misma debe estar en capacidad de gestionar los procesos administrativos, financieros, talento humano y nómina, logística y almacenes de la Casa Matriz y la Red de Servicios de Salud S.A, contribuyendo con la visión integral del Grupo INS y con la posibilidad de configurar otras subsidiarias a futuro. ',
                                        style: TextStyle(
                                          color: FlutterFlowTheme.of(context)
                                              .primaryBtnText,
                                        ),
                          ...
                          child: Row(
                            ...
                            children: [
                              ClipRRect(
                                borderRadius: BorderRadius.circular(8.0),
                                child: Image.network(
                                  'https://www.grupoins.com/media/15598/key-seguro-escritorio.jpg',
                                  width: 144.0,
                                  height: 116.0,
                                  fit: BoxFit.cover,
                                ),
                                ...
                                child: RichText(
                                  text: TextSpan(
                                    children: [
                                      ...
                                      TextSpan(
                                        text:
                                            ' \nEl alcance de este proyecto implica la modernización de la plataforma tecnológica institucional para la gestión de los contratos de seguros (negocio central del INS), que disponga de los mecanismos para el manejo de los distintos procesos de negocio, preparados para el entorno de un mercado en competencia. ',
                                        style: TextStyle(
                                          color: FlutterFlowTheme.of(context)
                                              .primaryBtnText,
                                        ),
